...
#
# Generated by Vivado on Thu Feb 05 15:10:00 EST 2026
...
#
#    "/home/wmatt/litefury_project2/project/project.srcs/sources_1/imports/HDL/dna_reader.v"
#    "/home/wmatt/litefury_project2/project/project.srcs/sources_1/imports/HDL/user_efuse.v"
#    "/home/wmatt/litefury_project2/project/project.srcs/sources_1/imports/HDL/CodeBlinker.v"
#    "/home/wmatt/litefury_project2/project/project.srcs/sources_1/imports/HDL/FireSim-generated.sv"
#    "/home/wmatt/litefury_project2/project/project.srcs/sources_1/imports/HDL/firesim_wrapper.v"
#    "/home/wmatt/litefury_project2/project/project.srcs/sources_1/imports/hdl/Top_wrapper.v"
#    "/home/wmatt/litefury_project2/project/project.srcs/sources_1/bd/Top/ip/Top_mig_7series_0_0/mig_a.prj"
#    "/home/wmatt/litefury_project2/project/project.srcs/sources_1/bd/Top/ip/Top_mig_7series_0_0/mig_b.prj"
#    "/home/wmatt/litefury_project2/project/project.srcs/constrs_1/imports/constraints/early.xdc"
#    "/home/wmatt/litefury_project2/project/project.srcs/constrs_1/imports/constraints/normal.xdc"
#
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/project.srcs/sources_1/imports/hdl/Top_wrapper.v"]"\
...
if { [get_files dna_reader.v] == "" } {
  import_files -quiet -fileset sources_1 /home/wmatt/litefury_project2/project/project.srcs/sources_1/imports/HDL/dna_reader.v
}
if { [get_files user_efuse.v] == "" } {
  import_files -quiet -fileset sources_1 /home/wmatt/litefury_project2/project/project.srcs/sources_1/imports/HDL/user_efuse.v
}
if { [get_files CodeBlinker.v] == "" } {
  import_files -quiet -fileset sources_1 /home/wmatt/litefury_project2/project/project.srcs/sources_1/imports/HDL/CodeBlinker.v
}
if { [get_files FireSim-generated.sv] == "" } {
  import_files -quiet -fileset sources_1 /home/wmatt/litefury_project2/project/project.srcs/sources_1/imports/HDL/FireSim-generated.sv
}
if { [get_files firesim_wrapper.v] == "" } {
  import_files -quiet -fileset sources_1 /home/wmatt/litefury_project2/project/project.srcs/sources_1/imports/HDL/firesim_wrapper.v
}
...
proc create_hier_cell_GPIO_regs { parentCell nameHier } {
  ...
  set_property CONFIG.Output_Width {2} $c_counter_binary_0
  ...
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/M02_ARESETN]
  connect_bd_net -net Version_dout [get_bd_pins Version/dout] [get_bd_pins axi_gpio_0/gpio2_io_i]
  connect_bd_net -net axi_gpio_2_gpio2_io_o [get_bd_pins axi_gpio_2/gpio2_io_o] [get_bd_pins gpio2_io_o]
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins c_counter_binary_0/Q] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net dna_reader_0_dna_ls [get_bd_pins dna_reader_0/dna_ls] [get_bd_pins axi_gpio_1/gpio_io_i]
  connect_bd_net -net dna_reader_0_dna_ms [get_bd_pins dna_reader_0/dna_ms] [get_bd_pins axi_gpio_1/gpio2_io_i]
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/M02_ACLK] [get_bd_pins c_counter_binary_0/CLK]
  connect_bd_net -net user_efuse_0_VAL [get_bd_pins user_efuse_0/VAL] [get_bd_pins axi_gpio_2/gpio_io_i]
  connect_bd_net -net xlconstant_3_dout [get_bd_pins Model/dout] [get_bd_pins axi_gpio_0/gpio_io_i]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins xlslice_0/Dout] [get_bd_pins dna_reader_0/clk]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M03_AXI [get_bd_intf_pins axi_interconnect_0/M03_AXI] [get_bd_intf_pins firesim_wrapper_0/S_AXI_CTRL]
  ...
  connect_bd_intf_net -intf_net firesim_wrapper_0_M_AXI_DDR0 [get_bd_intf_pins firesim_wrapper_0/M_AXI_DDR0] [get_bd_intf_pins axi_interconnect_1/S00_AXI]
  connect_bd_intf_net -intf_net mig_7series_0_DDR3 [get_bd_intf_ports DDR3] [get_bd_intf_pins mig_7series_0/DDR3]
  connect_bd_intf_net -intf_net xdma_0_M_AXI [get_bd_intf_pins xdma_0/M_AXI] [get_bd_intf_pins axi_clock_converter_0/S_AXI]
  ...
  # Create port connections
  connect_bd_net -net CodeBlinker_3_led [get_bd_pins CodeBlinker_3/led] [get_bd_ports LED_A1]
  connect_bd_net -net GPIO_regs_gpio2_io_o [get_bd_pins GPIO_regs/gpio2_io_o] [get_bd_pins xlslice_D1/Din] [get_bd_pins xlslice_D0/Din] [get_bd_pins xlslice_D4_D2/Din]
  connect_bd_net -net M00_ARESETN_1 [get_bd_pins util_vector_logic_0/Res] [get_bd_pins axi_interconnect_1/M00_ARESETN]
  connect_bd_net -net S00_ACLK_1 [get_bd_pins xdma_0/axi_aclk] [get_bd_pins GPIO_regs/s_axi_aclk] [get_bd_pins xadc_wiz_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_clock_converter_0/s_axi_aclk]
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins xdma_0/axi_aresetn] [get_bd_pins GPIO_regs/s_axi_aresetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_clock_converter_0/s_axi_aresetn]
  connect_bd_net -net S00_ARESETN_2 [get_bd_pins proc_sys_reset_0/interconnect_aresetn] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins firesim_wrapper_0/sys_reset_n] [get_bd_pins axi_clock_converter_0/m_axi_aresetn]
  connect_bd_net -net axi_quad_spi_0_ss_o [get_bd_pins axi_quad_spi_0/ss_o] [get_bd_ports real_spi_ss]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins firesim_wrapper_0/sys_clk_30] [get_bd_pins axi_clock_converter_0/m_axi_aclk]
  connect_bd_net -net const_true1_dout [get_bd_pins const_true1/dout] [get_bd_pins CodeBlinker_3/ok]
  connect_bd_net -net mig_7series_0_init_calib_complete [get_bd_pins mig_7series_0/init_calib_complete] [get_bd_ports LED_A4]
  connect_bd_net -net mig_7series_0_ui_addn_clk_0 [get_bd_pins mig_7series_0/ui_addn_clk_0] [get_bd_pins CodeBlinker_3/clk]
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins clk_wiz_0/clk_in1]
  ...
  connect_bd_net -net xadc_wiz_1_temp_out [get_bd_pins xadc_wiz_0/temp_out] [get_bd_pins mig_7series_0/device_temp_i]
  connect_bd_net -net xdma_0_user_lnk_up [get_bd_pins xdma_0/user_lnk_up] [get_bd_ports LED_A3]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconstant_1/dout] [get_bd_ports pcie_clkreq_l]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins xlconstant_2/dout] [get_bd_pins mig_7series_0/sys_rst] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins xlslice_D1/Dout] [get_bd_ports LED_M2]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins xlslice_D4_D2/Dout] [get_bd_pins CodeBlinker_3/code]
  connect_bd_net -net xlslice_D0_Dout [get_bd_pins xlslice_D0/Dout] [get_bd_ports LED_A2]
